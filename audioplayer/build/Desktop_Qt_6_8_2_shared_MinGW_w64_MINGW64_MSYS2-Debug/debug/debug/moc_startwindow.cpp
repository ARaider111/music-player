...
#include "../../../../../music-player-master/audioplayer/startwindow.h"
...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (StartWindow::*)(const QString & );
            if (_q_method_type _q_method = &StartWindow::folderSelected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StartWindow::folderSelected(const QString & _t1)
{
